...
SRCS := main.cpp WauBulan.cpp SwingingKid.cpp FallingObstacle.cpp FlyingObstacle.cpp SwayingObstacle.cpp GapObstacle.cpp ObstacleSpawner.cpp CollisionManager.cpp ScoreManager.cpp Background.cpp BungaRaya.cpp ItemSpawner.cpp
OBJS := $(SRCS:.cpp=.o)
