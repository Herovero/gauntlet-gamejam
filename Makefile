...
SRCS := main.cpp WauBulan.cpp SwingingKid.cpp FallingObstacle.cpp FlyingObstacle.cpp GapObstacle.cpp BouncingObstacle.cpp ObstacleSpawner.cpp CollisionManager.cpp ScoreManager.cpp Background.cpp BungaRaya.cpp TaliTangsi.cpp ItemSpawner.cpp
OBJS := $(SRCS:.cpp=.o)
