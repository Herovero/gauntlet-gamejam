...
SRCS := main.cpp WauBulan.cpp SwingingKid.cpp FallingObstacle.cpp FlyingObstacle.cpp GapObstacle.cpp BouncingObstacle.cpp ObstacleSpawner.cpp CollisionManager.cpp ScoreManager.cpp CoinManager.cpp Background.cpp BungaRaya.cpp TaliTangsi.cpp Coin.cpp ItemSpawner.cpp
OBJS := $(SRCS:.cpp=.o)
